...
const
  ...
  SVN_PROP_INHERITABLE_AUTO_PROPS = SVN_PROP_PREFIX + 'auto-props';
  SVN_PROP_INHERITABLE_IGNORES = SVN_PROP_PREFIX + 'global-ignores';
  SVN_PROP_TEXT_TIME = SVN_PROP_PREFIX + 'text-time';
  SVN_PROP_OWNER = SVN_PROP_PREFIX + 'owner';
  SVN_PROP_GROUP = SVN_PROP_PREFIX + 'group';
  SVN_PROP_UNIX_MODE = SVN_PROP_PREFIX + 'unix-mode';
  SVN_PROP_NODE_ALL_PROPS: array[0..14] of string = (
    SVN_PROP_MIME_TYPE,
    SVN_PROP_IGNORE,
    SVN_PROP_EOL_STYLE,
    SVN_PROP_KEYWORDS,
  ...
  SVN_PROP_TXN_PREFIX = SVN_PROP_PREFIX + 'txn-';
  SVN_PROP_TXN_CLIENT_COMPAT_VERSION = SVN_PROP_TXN_PREFIX + 'client-compat-version';
  SVN_PROP_TXN_USER_AGENT = SVN_PROP_TXN_PREFIX + 'user-agent';
  SVN_PROP_REVISION_PREFIX = SVN_PROP_PREFIX + 'revision-';
...
const
  ...
  SVN_ERR_MALFUNC_CATEGORY_START                  = APR_OS_START_USERERR + 23 * SVN_ERR_CATEGORY_SIZE;
  ...
  SVN_ERR_WC_NOT_WORKING_COPY                     = SVN_ERR_WC_CATEGORY_START + 7;//Subversion 1.7 and higher
...
const
  ...
  SVN_CONFIG_OPTION_STORE_PLAINTEXT_PASSWORDS = 'store-plaintext-passwords';
  SVN_CONFIG_OPTION_STORE_AUTH_CREDS = 'store-auth-creds';
  SVN_CONFIG_OPTION_STORE_SSL_CLIENT_CERT_PP = 'store-ssl-client-cert-pp';
  SVN_CONFIG_OPTION_STORE_SSL_CLIENT_CERT_PP_PLAINTEXT = 'store-ssl-client-cert-pp-plaintext';
  SVN_CONFIG_OPTION_USERNAME = 'username';
  SVN_CONFIG_OPTION_HTTP_BULK_UPDATES = 'http-bulk-updates';
  SVN_CONFIG_OPTION_HTTP_MAX_CONNECTIONS = 'http-max-connections';
  SVN_CONFIG_OPTION_PASSWORD_STORES = 'password-stores';
  SVN_CONFIG_OPTION_KWALLET_WALLET = 'kwallet-wallet';
  SVN_CONFIG_OPTION_KWALLET_SVN_APPLICATION_NAME_WITH_PID = 'kwallet-svn-application-name-with-pid';
  SVN_CONFIG_OPTION_SSL_CLIENT_CERT_FILE_PROMPT = 'ssl-client-cert-file-prompt';
  ...
  SVN_CONFIG_OPTION_MEMORY_CACHE_SIZE = 'memory-cache-size';
  SVN_CONFIG_SECTION_TUNNELS = 'tunnels';
  SVN_CONFIG_SECTION_AUTO_PROPS = 'auto-props';
  SVN_CONFIG_SECTION_WORKING_COPY = 'working-copy';
  SVN_CONFIG_OPTION_SQLITE_EXCLUSIVE = 'exclusive-locking';
  SVN_CONFIG_OPTION_SQLITE_EXCLUSIVE_CLIENTS = 'exclusive-locking-clients';
  ...
  SVN_CONFIG_OPTION_GROUPS_DB = 'groups-db';
  SVN_CONFIG_OPTION_FORCE_USERNAME_CASE = 'force-username-case';
  SVN_CONFIG_OPTION_HOOKS_ENV = 'hooks-env';
  ...
  SVN_CONFIG__DEFAULT_GLOBAL_IGNORES_LINE_1 = '*.o *.lo *.la *.al .libs *.so *.so.[0-9]* *.a *.pyc *.pyo __pycache__';
  SVN_CONFIG__DEFAULT_GLOBAL_IGNORES_LINE_2 = '*.rej *~ #*# .#* .*.swp .DS_Store';
  SVN_CONFIG_DEFAULT_GLOBAL_IGNORES = SVN_CONFIG__DEFAULT_GLOBAL_IGNORES_LINE_1 + ' ' + SVN_CONFIG__DEFAULT_GLOBAL_IGNORES_LINE_2;

  SVN_CONFIG_TRUE = 'TRUE';
  SVN_CONFIG_FALSE = 'FALSE';
  SVN_CONFIG_ASK = 'ASK';
  SVN_CONFIG_DEFAULT_OPTION_STORE_PASSWORDS = TRUE;
  SVN_CONFIG_DEFAULT_OPTION_STORE_PLAINTEXT_PASSWORDS = SVN_CONFIG_ASK;
  SVN_CONFIG_DEFAULT_OPTION_STORE_AUTH_CREDS = TRUE;
  SVN_CONFIG_DEFAULT_OPTION_STORE_SSL_CLIENT_CERT_PP = TRUE;
  SVN_CONFIG_DEFAULT_OPTION_STORE_SSL_CLIENT_CERT_PP_PLAINTEXT = SVN_CONFIG_ASK;
  SVN_CONFIG_DEFAULT_OPTION_HTTP_MAX_CONNECTIONS = 4;
...
type
  ...
  PSvnIODirEnt2 = ^TSvnIODirEnt2;
  TSvnIODirEnt2 = record
    kind: TSvnNodeKind;
    special: TSvnBoolean;
    filesize: TSvnFileSize;
    mtime: TAprTime;
  end;
...
type
  ...
  TSvnWcStatusFunc3 = function(baton: Pointer; path: PAnsiChar; status: PSvnWcStatus2; pool: PAprPool): PSvnError; cdecl;
...
type
  ...
  TSvnPropListReceiver2 = function(baton: Pointer; path: PAnsiChar; prop_hash: PAprHash;
    inherited_props: PAprArrayHeader; scratch_pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnClientGetCommitLog = function(out log_msg, tmp_file: PAnsiChar; commit_items: PAprArrayHeader; baton: Pointer;
    pool: PAprPool): PSvnError; cdecl;
  TSvnClientBlameReceiver3 = function(baton: Pointer; start_revnum, end_revnum: TSvnRevNum; line_no: Int64;
    revision: TSvnRevNum; rev_props: PAprHash; merged_revision: TSvnRevNum; merged_rev_props: PAprHash;
    merged_path, line: PAnsiChar; local_change: TSvnBoolean; pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnClientDiffSummarizeFunc = function(diff: PSvnClientDiffSummarize; baton: Pointer; pool: PAprPool): PSvnError;
    cdecl;
  TSvnClientListFunc2 = function(baton: Pointer; path: PAnsiChar; dirent: PSvnDirEnt; lock: PSvnLock;
    abs_path, external_parent_url, external_target: PAnsiChar; scratch_pool: PAprPool): PSvnError; cdecl;
  ...
  TSvnClientImportFilterFunc = function(baton: Pointer; out filtered: TSvnBoolean; local_abspath: PAnsiChar;
    dirent: PSvnIODirEnt2; scratch_pool: PAprPool): PSvnError; cdecl;
  PSvnClientStatus = ^TSvnClientStatus;
  TSvnClientStatus = record
    kind: TSvnNodeKind;
    local_abspath: PAnsiChar;
    filesize: TSvnFileSize;
    versioned: TSvnBoolean;
    conflicted: TSvnBoolean;
    node_status: TSvnWcStatusKind;
    text_status: TSvnWcStatusKind;
    prop_status: TSvnWcStatusKind;
    wc_is_locked: TSvnBoolean;
    copied: TSvnBoolean;
    repos_root_url: PAnsiChar;
    repos_uuid: PAnsiChar;
    repos_relpath: PAnsiChar;
    revision: TSvnRevNum;
    changed_rev: TSvnRevNum;
    changed_date: TAprTime;
    changed_author: PAnsiChar;
    switched: TSvnBoolean;
    file_external: TSvnBoolean;
    lock: PSvnLock;
    changelist: PAnsiChar;
    depth: TSvnDepth;
    ood_kind: TSvnNodeKind;
    repos_node_status: TSvnWcStatusKind;
    repos_text_status: TSvnWcStatusKind;
    repos_prop_status: TSvnWcStatusKind;
    repos_lock: PSvnLock;
    ood_changed_rev: TSvnRevNum;
    ood_changed_date: TAprTime;
    ood_changed_author: PAnsiChar;
    backwards_compatibility_baton: Pointer;
    moved_from_abspath: PAnsiChar;
    moved_to_abspath: PAnsiChar;
  end;
  TSvnClientStatusFunc = function(baton: Pointer; path: PAnsiChar; status: PSvnClientStatus;
  ...
  PSvnClientInfo2 = ^TSvnClientInfo2;
  TSvnClientInfo2 = record
    URL: PAnsiChar;
    rev: TSvnRevNum;
    repos_root_URL: PAnsiChar;
    repos_UUID: PAnsiChar;
  ...
  TSvnClientPatchFunc = function(baton: Pointer; out filtered: TSvnBoolean;
    canon_path_from_patchfile, patch_abspath, reject_abspath: PAnsiChar; scratch_pool: PAprPool): PSvnError; cdecl;
...
var
  ...
  svn_client_commit_item3_create: function(pool: PAprPool): PSvnClientCommitItem3; cdecl;
  ...
  svn_client_create_context2: function(out ctx: PSvnClientCtx; cfg_hash: PAprHash; pool: PAprPool): PSvnError; cdecl;
  svn_client_create_context: function(out ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_args_to_target_array2: function(targets_p: PPAprArrayHeader; os: PAprGetOpt;
    known_targets: PAprArrayHeader; ctx: PSvnClientCtx; keep_last_origpath_on_truepath_collision: TSvnBoolean;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_args_to_target_array: function(targets_p: PPAprArrayHeader; os: PAprGetOpt;
    known_targets: PAprArrayHeader; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_update4: function(result_revs: PPAprArrayHeader; paths: PAprArrayHeader; revision: PSvnOptRevision;
    depth: TSvnDepth;
    depth_is_sticky, ignore_externals, allow_unver_obstructions, adds_as_modification, make_parents: TSvnBoolean;
  ...
  svn_client_update: function(out result_rev: TSvnRevNum; path: PAnsiChar; revision: PSvnOptRevision; recurse: TSvnBoolean;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_switch3: function(out result_rev: TSvnRevNum; path, url: PAnsiChar;
    peg_revision, revision: PSvnOptRevision; depth: TSvnDepth;
    depth_is_sticky, ignore_externals, allow_unver_obstructions, ignore_ancestry: TSvnBoolean; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_switch: function(out result_rev: TSvnRevNum; path, url: PAnsiChar; revision: PSvnOptRevision;
    recurse: TSvnBoolean; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_add5: function(path: PAnsiChar; depth: TSvnDepth;
    force, no_ignore, no_autoprops, add_parents: TSvnBoolean; ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError;
    cdecl;
  ...
  svn_client_mkdir4: function(paths: PAprArrayHeader; make_parents: TSvnBoolean; revprop_table: PAprHash;
    commit_callback: TSvnCommitCallback2; commit_baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_mkdir: function(out commit_info_p: PSvnCommitInfo; paths: PAprArrayHeader; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_delete4: function(paths: PAprArrayHeader; force, keep_local: TSvnBoolean; revprop_table: PAprHash;
    commit_callback: TSvnCommitCallback2; commit_baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_delete: function(out commit_info_p: PSvnCommitInfo; paths: PAprArrayHeader; force: TSvnBoolean;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_import5: function(path, url: PAnsiChar; depth: TSvnDepth;
    no_ignore, no_autoprops, ignore_unknown_node_types: TSvnBoolean; revprop_table: PAprHash;
    filter_callback: TSvnClientImportFilterFunc; filter_baton: Pointer; commit_callback: TSvnCommitCallback2;
    commit_baton: Pointer; ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_import4: function(path, url: PAnsiChar; depth: TSvnDepth;
    no_ignore, ignore_unknown_node_types: TSvnBoolean; revprop_table: PAprHash; commit_callback: TSvnCommitCallback2;
    commit_baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_import: function(out commit_info_p: PSvnCommitInfo; path, url: PAnsiChar; nonrecursive: TSvnBoolean;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_commit6: function(targets: PAprArrayHeader; depth: TSvnDepth;
    keep_locks, keep_changelists, commit_as_operations, include_file_externals, include_dir_externals: TSvnBoolean;
    changelists: PAprArrayHeader; revprop_table: PAprHash; commit_callback: TSvnCommitCallback2; commit_baton: Pointer;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_commit5: function(targets: PAprArrayHeader; depth: TSvnDepth;
    keep_locks, keep_changelists, commit_as_operations: TSvnBoolean; changelists: PAprArrayHeader;
    revprop_table: PAprHash; commit_callback: TSvnCommitCallback2; commit_baton: Pointer; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_status_dup: function(status: PSvnClientStatus; result_pool: PAprPool): PSvnClientStatus;
    cdecl;
  svn_client_status5: function(out result_rev: TSvnRevNum; ctx: PSvnClientCtx; path: PAnsiChar;
    revision: PSvnOptRevision; depth: TSvnDepth;
    get_all, update, no_ignore, ignore_externals, depth_as_sticky: TSvnBoolean; changelists: PAprArrayHeader;
    status_func: TSvnClientStatusFunc; status_baton: Pointer; scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_status4: function(result_rev: PSvnRevNum; path: PAnsiChar; revision: PSvnOptRevision;
    status_func: TSvnWcStatusFunc3; status_baton: Pointer; depth: TSvnDepth;
  ...
  svn_client_status: function(out result_rev: TSvnRevNum; path: PAnsiChar; revision: PSvnOptRevision;
    ...
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_log5: function(targets: PAprArrayHeader; peg_revision: PSvnOptRevision; revision_ranges: PAprArrayHeader;
    limit: Integer; discover_changed_paths, strict_node_history, include_merged_revisions: TSvnBoolean;
    revprops: PAprArrayHeader; receiver: TSvnLogEntryReceiver; receiver_baton: Pointer; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_log: function(targets: PAprArrayHeader; rev_start, rev_end: PSvnOptRevision;
    discover_changed_paths, strict_node_history: TSvnBoolean; receiver: TSvnLogMessageReceiver; receiver_baton: Pointer;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_blame5: function(path_or_url: PAnsiChar; peg_revision, rev_start, rev_end: PSvnOptRevision;
    diff_options: PSvnDiffFileOptions; ignore_mime_type, include_merged_revisions: TSvnBoolean;
    receiver: TSvnClientBlameReceiver3; receiver_baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError;
    cdecl;
  ...
  svn_client_blame: function(path_or_url: PAnsiChar; rev_start, rev_end: PSvnOptRevision; receiver: TSvnClientBlameReceiver;
    receiver_baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_diff6: function(diff_options: PAprArrayHeader; path_or_url1: PAnsiChar; revision1: PSvnOptRevision;
    path_or_url2: PAnsiChar; revision2: PSvnOptRevision; relative_to_dir: PAnsiChar; depth: TSvnDepth;
    ignore_ancestry, no_diff_added, no_diff_deleted, show_copies_as_adds, ignore_content_type, ignore_properties, properties_only, use_git_diff_format: TSvnBoolean;
    header_encoding: PAnsiChar; outstream, errstream: PSvnStream; changelists: PAprArrayHeader; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_diff5: function(diff_options: PAprArrayHeader; path1: PAnsiChar; revision1: PSvnOptRevision;
    path2: PAnsiChar; revision2: PSvnOptRevision; relative_to_dir: PAnsiChar; depth: TSvnDepth;
    ignore_ancestry, no_diff_deleted, show_copies_as_adds, ignore_content_type, use_git_diff_format: TSvnBoolean;
    header_encoding: PAnsiChar; outfile, errfile: PAprFile; changelists: PAprArrayHeader; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_diff: function(diff_options: PAprArrayHeader; path1: PAnsiChar; revision1: PSvnOptRevision; path2: PAnsiChar;
    ...
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_diff_peg6: function(diff_options: PAprArrayHeader; path_or_url: PAnsiChar;
    peg_revision, start_revision, end_revision: PSvnOptRevision; relative_to_dir: PAnsiChar; depth: TSvnDepth;
    ignore_ancestry, no_diff_added, no_diff_deleted, show_copies_as_adds, ignore_content_type, ignore_properties, properties_only, use_git_diff_format: TSvnBoolean;
    header_encoding: PAnsiChar; outstream, errstream: PSvnStream; changelists: PAprArrayHeader; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_diff_peg5: function(diff_options: PAprArrayHeader; path: PAnsiChar;
    peg_revision, start_revision, end_revision: PSvnOptRevision; relative_to_dir: PAnsiChar; depth: TSvnDepth;
    ignore_ancestry, no_diff_deleted, show_copies_as_adds, ignore_content_type, use_git_diff_format: TSvnBoolean;
    header_encoding: PAnsiChar; outfile, errfile: PAprFile; changelists: PAprArrayHeader; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_diff_summarize_peg: function(path: PAnsiChar; peg_revision, start_revision, end_revision: PSvnOptRevision;
    ...
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_get_merging_summary: function(needs_reintegration: PSvnBoolean; out yca_url: PAnsiChar;
    out yca_rev: TSvnRevNum; out base_url: PAnsiChar; out base_rev: TSvnRevNum; out right_url: PAnsiChar;
    out right_rev: TSvnRevNum; out target_url: PAnsiChar; out target_rev: TSvnRevNum;
    out repos_root_url, source_path_or_url: PAnsiChar; source_revision: PSvnOptRevision; target_path_or_url: PAnsiChar;
    target_revision: PSvnOptRevision; ctx: PSvnClientCtx; result_pool, scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_merge5: function(source1: PAnsiChar; revision1: PSvnOptRevision; source2: PAnsiChar;
    revision2: PSvnOptRevision; target_wcpath: PAnsiChar; depth: TSvnDepth;
    ignore_mergeinfo, diff_ignore_ancestry, force_delete, record_only, dry_run, allow_mixed_rev: TSvnBoolean;
    merge_options: PAprArrayHeader; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_merge4: function(source1: PAnsiChar; revision1: PSvnOptRevision; source2: PAnsiChar;
    revision2: PSvnOptRevision; target_wcpath: PAnsiChar; depth: TSvnDepth;
    ignore_ancestry, force_delete, record_only, dry_run, allow_mixed_rev: TSvnBoolean; merge_options: PAprArrayHeader;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_merge_peg5: function(source_path_or_url: PAnsiChar; ranges_to_merge: PAprArrayHeader;
    source_peg_revision: PSvnOptRevision; target_wcpath: PAnsiChar; depth: TSvnDepth;
    ignore_mergeinfo, diff_ignore_ancestry, force_delete, record_only, dry_run, allow_mixed_rev: TSvnBoolean;
    merge_options: PAprArrayHeader; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_merge_peg4: function(source_path_or_url: PAnsiChar; ranges_to_merge: PAprArrayHeader;
    source_peg_revision: PSvnOptRevision; target_wcpath: PAnsiChar; depth: TSvnDepth;
    ignore_ancestry, force_delete, record_only, dry_run, allow_mixed_rev: TSvnBoolean; merge_options: PAprArrayHeader;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_mergeinfo_get_merged: function(out mergeinfo: PAprHash; path_or_url: PAnsiChar; peg_revision: PSvnOptRevision;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_mergeinfo_log2: function(finding_merged: TSvnBoolean; target_path_or_url: PAnsiChar;
    target_peg_revision: PSvnOptRevision; source_path_or_url: PAnsiChar;
    source_peg_revision, source_start_revision, source_end_revision: PSvnOptRevision; receiver: TSvnLogEntryReceiver;
    receiver_baton: Pointer; discover_changed_paths: TSvnBoolean; depth: TSvnDepth; revprops: PAprArrayHeader;
    ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_mergeinfo_log: function(finding_merged: TSvnBoolean; target_path_or_url: PAnsiChar;
    target_peg_revision: PSvnOptRevision; source_path_or_url: PAnsiChar; source_peg_revision: PSvnOptRevision;
    receiver: TSvnLogEntryReceiver; receiver_baton: Pointer; discover_changed_paths: TSvnBoolean; depth: TSvnDepth;
    revprops: PAprArrayHeader; ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_upgrade: function(wcroot_dir: PAnsiChar; ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_relocate2: function(wcroot_dir, from_prefix, to_prefix: PAnsiChar; ignore_externals: TSvnBoolean;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_resolve: function(path: PAnsiChar; depth: TSvnDepth; conflict_choice: TSvnWcConflictChoice; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_copy6: function(sources: PAprArrayHeader; dst_path: PAnsiChar;
    copy_as_child, make_parents, ignore_externals: TSvnBoolean; revprop_table: PAprHash;
    commit_callback: TSvnCommitCallback2; commit_baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_copy5: function(out commit_info_p: PSvnCommitInfo; sources: PAprArrayHeader; dst_path: PAnsiChar;
    copy_as_child, make_parents, ignore_externals: TSvnBoolean; revprop_table: PAprHash; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_copy: function(out commit_info_p: PSvnCommitInfo; src_path: PAnsiChar; src_revision: PSvnOptRevision;
    dst_path: PAnsiChar; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_move7: function(src_paths: PAprArrayHeader; dst_path: PAnsiChar;
    move_as_child, make_parents, allow_mixed_revisions, metadata_only: TSvnBoolean; revprop_table: PAprHash;
    commit_callback: TSvnCommitCallback2; commit_baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_move6: function(src_paths: PAprArrayHeader; dst_path: PAnsiChar; move_as_child, make_parents: TSvnBoolean;
    revprop_table: PAprHash; commit_callback: TSvnCommitCallback2; commit_baton: Pointer; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_propset_remote: function(propname: PAnsiChar; propval: PSvnString; url: PAnsiChar;
    skip_checks: TSvnBoolean; base_revision_for_url: TSvnRevNum; revprop_table: PAprHash;
    commit_callback: TSvnCommitCallback2; commit_baton: Pointer; ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError;
    cdecl;
  svn_client_propset_local: function(propname: PAnsiChar; propval: PSvnString; targets: PAprArrayHeader;
    depth: TSvnDepth; skip_checks: TSvnBoolean; changelists: PAprArrayHeader; ctx: PSvnClientCtx;
    scratch_pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_propset: function(propname: PAnsiChar; propval: PSvnString; target: PAnsiChar; recurse: TSvnBoolean;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_revprop_set2: function(propname: PAnsiChar; propval, original_propval: PSvnString; URL: PAnsiChar;
    revision: PSvnOptRevision; out set_rev: TSvnRevNum; force: TSvnBoolean; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_propget5: function(out props: PAprHash; inherited_props: PPAprArrayHeader; propname, target: PAnsiChar;
    peg_revision, revision: PSvnOptRevision; out actual_revnum: TSvnRevNum; depth: TSvnDepth;
    changelists: PAprArrayHeader; ctx: PSvnClientCtx; result_pool, scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_propget4: function(out props: PAprHash; propname, target: PAnsiChar;
    peg_revision, revision: PSvnOptRevision; out actual_revnum: TSvnRevNum; depth: TSvnDepth;
    changelists: PAprArrayHeader; ctx: PSvnClientCtx; result_pool, scratch_pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_proplist4: function(target: PAnsiChar; peg_revision, revision: PSvnOptRevision; depth: TSvnDepth;
    changelists: PAprArrayHeader; get_target_inherited_props: TSvnBoolean; receiver: TSvnPropListReceiver2;
    receiver_baton: Pointer; ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_revprop_list: function(out props: PAprHash; URL: PAnsiChar; revision: PSvnOptRevision; out set_rev: TSvnRevNum;
    ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  svn_client_export5: function(out result_rev: TSvnRevNum; from_path_or_url, to_path: PAnsiChar;
    peg_revision, revision: PSvnOptRevision; overwrite, ignore_externals, ignore_keywords: TSvnBoolean; depth: TSvnDepth;
  ...
  svn_client_list3: function(path_or_url: PAnsiChar; peg_revision, revision: PSvnOptRevision; depth: TSvnDepth;
    dirent_fields: Cardinal; fetch_locks, include_externals: TSvnBoolean; list_func: TSvnClientListFunc2;
    baton: Pointer; ctx: PSvnClientCtx; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_info2_dup: function(info: PSvnClientInfo2; pool: PAprPool): PSvnClientInfo2; cdecl;
  svn_client_info3: function(abspath_or_url: PAnsiChar; peg_revision, revision: PSvnOptRevision; depth: TSvnDepth;
    fetch_excluded, fetch_actual_only: TSvnBoolean; changelists: PAprArrayHeader;
    receiver: TSvnClientInfoReceiver2; receiver_baton: Pointer; ctx: PSvnClientCtx;
    scratch_pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_get_wc_root: function(out wcroot_abspath, local_abspath: PAnsiChar; ctx: PSvnClientCtx;
    result_pool, scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_min_max_revisions: function(out min_revision, max_revision: TSvnRevNum; local_abspath: PAnsiChar;
    committed: TSvnBoolean; ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_patch: function(patch_abspath, wc_dir_abspath: PAnsiChar; dry_run: TSvnBoolean; strip_count: Integer;
    reverse, ignore_whitespace, remove_tempfiles: TSvnBoolean; patch_func: TSvnClientPatchFunc;
    patch_baton: Pointer; ctx: PSvnClientCtx; scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_url_from_path2: function(out url, path_or_url: PAnsiChar; ctx: PSvnClientCtx;
    result_pool, scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_url_from_path: function(out url: PAnsiChar; path_or_url: PAnsiChar; pool: PAprPool): PSvnError; cdecl;
  svn_client_get_repos_root: function(out repos_root_url, repos_uuid, abspath_or_url: PAnsiChar; ctx: PSvnClientCtx;
    result_pool, scratch_pool: PAprPool): PSvnError; cdecl;
  ...
  svn_client_uuid_from_url: function(out uuid: PAnsiChar; url: PAnsiChar; ctx: PSvnClientCtx; pool: PAprPool): PSvnError;
    cdecl;
  svn_client_uuid_from_path2: function(out uuid, local_abspath: PAnsiChar; ctx: PSvnClientCtx;
    result_pool, scratch_pool: PAprPool): PSvnError; cdecl;
  svn_client_uuid_from_path: function(out uuid: PAnsiChar; path: PAnsiChar; adm_access: PSvnWcAdmAccess; ctx: PSvnClientCtx;
    pool: PAprPool): PSvnError; cdecl;
  svn_client_open_ra_session2: function(out session: PSvnRaSession; url, wri_abspath: PAnsiChar; ctx: PSvnClientCtx;
    result_pool, scratch_pool: PAprPool): PSvnError; cdecl;
...
begin
  ...
  begin
    ...
    begin
      ...
      @svn_client_add5 := GetProcAddress(SvnClientLib, 'svn_client_add5');
      @svn_client_add_to_changelist := GetProcAddress(SvnClientLib, 'svn_client_add_to_changelist');
      @svn_client_args_to_target_array := GetProcAddress(SvnClientLib, 'svn_client_args_to_target_array');
      @svn_client_args_to_target_array2 := GetProcAddress(SvnClientLib, 'svn_client_args_to_target_array2');
      ...
      @svn_client_blame5 := GetProcAddress(SvnClientLib, 'svn_client_blame5');
      ...
      @svn_client_commit5 := GetProcAddress(SvnClientLib, 'svn_client_commit5');
      @svn_client_commit6 := GetProcAddress(SvnClientLib, 'svn_client_commit6');
      @svn_client_commit_item2_dup := GetProcAddress(SvnClientLib, 'svn_client_commit_item2_dup');
      @svn_client_commit_item3_create := GetProcAddress(SvnClientLib, 'svn_client_commit_item3_create');
      ...
      @svn_client_copy5 := GetProcAddress(SvnClientLib, 'svn_client_copy5');
      @svn_client_copy6 := GetProcAddress(SvnClientLib, 'svn_client_copy6');
      @svn_client_create_context := GetProcAddress(SvnClientLib, 'svn_client_create_context');
      @svn_client_create_context2 := GetProcAddress(SvnClientLib, 'svn_client_create_context2');
      ...
      @svn_client_delete4 := GetProcAddress(SvnClientLib, 'svn_client_delete4');
      ...
      @svn_client_diff5 := GetProcAddress(SvnClientLib, 'svn_client_diff5');
      @svn_client_diff6 := GetProcAddress(SvnClientLib, 'svn_client_diff6');
      ...
      @svn_client_diff_peg5 := GetProcAddress(SvnClientLib, 'svn_client_diff_peg5');
      @svn_client_diff_peg6 := GetProcAddress(SvnClientLib, 'svn_client_diff_peg6');
      ...
      @svn_client_export5 := GetProcAddress(SvnClientLib, 'svn_client_export5');
      @svn_client_get_changelists := GetProcAddress(SvnClientLib, 'svn_client_get_changelists');
      @svn_client_get_merging_summary := GetProcAddress(SvnClientLib, 'svn_client_get_merging_summary');
      @svn_client_get_repos_root := GetProcAddress(SvnClientLib, 'svn_client_get_repos_root');
      ...
      @svn_client_get_wc_root := GetProcAddress(SvnClientLib, 'svn_client_get_wc_root');
      ...
      @svn_client_import4 := GetProcAddress(SvnClientLib, 'svn_client_import4');
      @svn_client_import5 := GetProcAddress(SvnClientLib, 'svn_client_import5');
      @svn_client_info := GetProcAddress(SvnClientLib, 'svn_client_info');
      @svn_client_info2 := GetProcAddress(SvnClientLib, 'svn_client_info2');
      @svn_client_info2_dup := GetProcAddress(SvnClientLib, 'svn_client_info2_dup');
      @svn_client_info3 := GetProcAddress(SvnClientLib, 'svn_client_info3');
      @svn_client_list := GetProcAddress(SvnClientLib, 'svn_client_list');
      @svn_client_list2 := GetProcAddress(SvnClientLib, 'svn_client_list2');
      @svn_client_list3 := GetProcAddress(SvnClientLib, 'svn_client_list3');
      ...
      @svn_client_log5 := GetProcAddress(SvnClientLib, 'svn_client_log5');
      ...
      @svn_client_merge4 := GetProcAddress(SvnClientLib, 'svn_client_merge4');
      @svn_client_merge5 := GetProcAddress(SvnClientLib, 'svn_client_merge5');
      ...
      @svn_client_merge_peg4 := GetProcAddress(SvnClientLib, 'svn_client_merge_peg4');
      @svn_client_merge_peg5 := GetProcAddress(SvnClientLib, 'svn_client_merge_peg5');
      ...
      @svn_client_mergeinfo_log := GetProcAddress(SvnClientLib, 'svn_client_mergeinfo_log');
      @svn_client_mergeinfo_log2 := GetProcAddress(SvnClientLib, 'svn_client_mergeinfo_log2');
      ...
      @svn_client_min_max_revisions := GetProcAddress(SvnClientLib, 'svn_client_min_max_revisions');
      ...
      @svn_client_mkdir4 := GetProcAddress(SvnClientLib, 'svn_client_mkdir4');
      ...
      @svn_client_move6 := GetProcAddress(SvnClientLib, 'svn_client_move6');
      @svn_client_move7 := GetProcAddress(SvnClientLib, 'svn_client_move7');
      @svn_client_open_ra_session := GetProcAddress(SvnClientLib, 'svn_client_open_ra_session');
      @svn_client_open_ra_session2 := GetProcAddress(SvnClientLib, 'svn_client_open_ra_session2');
      @svn_client_patch := GetProcAddress(SvnClientLib, 'svn_client_patch');
      ...
      @svn_client_propget4 := GetProcAddress(SvnClientLib, 'svn_client_propget4');
      @svn_client_propget5 := GetProcAddress(SvnClientLib, 'svn_client_propget5');
      ...
      @svn_client_proplist4 := GetProcAddress(SvnClientLib, 'svn_client_proplist4');
      ...
      @svn_client_propset_local := GetProcAddress(SvnClientLib, 'svn_client_propset_local');
      @svn_client_propset_remote := GetProcAddress(SvnClientLib, 'svn_client_propset_remote');
      @svn_client_relocate := GetProcAddress(SvnClientLib, 'svn_client_relocate');
      @svn_client_relocate2 := GetProcAddress(SvnClientLib, 'svn_client_relocate2');
      ...
      @svn_client_revprop_set2 := GetProcAddress(SvnClientLib, 'svn_client_revprop_set2');
      ...
      @svn_client_status4 := GetProcAddress(SvnClientLib, 'svn_client_status4');
      @svn_client_status5 := GetProcAddress(SvnClientLib, 'svn_client_status5');
      @svn_client_status_dup := GetProcAddress(SvnClientLib, 'svn_client_status_dup');
      ...
      @svn_client_switch3 := GetProcAddress(SvnClientLib, 'svn_client_switch3');
      ...
      @svn_client_update4 := GetProcAddress(SvnClientLib, 'svn_client_update4');
      @svn_client_upgrade := GetProcAddress(SvnClientLib, 'svn_client_upgrade');
      @svn_client_url_from_path := GetProcAddress(SvnClientLib, 'svn_client_url_from_path');
      @svn_client_url_from_path2 := GetProcAddress(SvnClientLib, 'svn_client_url_from_path2');
      @svn_client_uuid_from_path := GetProcAddress(SvnClientLib, 'svn_client_uuid_from_path');
      @svn_client_uuid_from_path2 := GetProcAddress(SvnClientLib, 'svn_client_uuid_from_path2');
...
begin
  ...
  @svn_client_args_to_target_array := nil;
  @svn_client_args_to_target_array2 := nil;
  @svn_client_blame := nil;
  @svn_client_blame2 := nil;
  @svn_client_blame3 := nil;
  @svn_client_blame4 := nil;
  @svn_client_blame5 := nil;
  @svn_client_cat := nil;
  @svn_client_cat2 := nil;
  ...
  @svn_client_commit5 := nil;
  @svn_client_commit6 := nil;
  @svn_client_commit_item2_dup := nil;
  @svn_client_commit_item3_create := nil;
  ...
  @svn_client_export5 := nil;
  @svn_client_get_changelists := nil;
  @svn_client_get_merging_summary := nil;
  @svn_client_get_repos_root := nil;
